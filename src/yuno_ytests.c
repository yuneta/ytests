 ...
 *          Register
 ***************************************************************************/
PUBLIC void register_yuno_ytests(void)
{
    GCLASS *gclass;
     ...
     */
    gclass = gobj_subclass_gclass(gclass_default_yuno(), GCLASS_YUNO_YTESTS_NAME);
    ...
    gobj_register_yuno(ROLE_YTESTS, gclass, TRUE);
}
